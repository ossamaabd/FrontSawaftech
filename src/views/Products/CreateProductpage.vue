    ...
    <v-container>
      ...
      <v-row align="center" class="justify-center">
        ...
        >
          ...
          <form ref="form" @submit="CreateProduct">
            ...
            <button type="submit" class="btn btn-success my_button ma-4" >Create Product</button>
  ...
  methods: {
    CreateProduct(e) {
      e.preventDefault();
        ...
        axios
          .post(process.env.VUE_APP_ROOT_API+"Products/CreateProduct", {
